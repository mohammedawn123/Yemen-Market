    ...
    <div class="container">
        ...
        <div id="top-links" class="nav pull-right">
            <ul class="list-inline">
                ...
                <li><a href="{{route('cart.list')}}" title="Shopping Cart">
                     ...
                     <li>
                            <table class="table table-striped">
                                ...
                                @foreach($cart['items'] as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('item.remove' , ['id'=> $item['id'] , 'instance'=>'default'])}}" data-toggle="tooltip" title="" class="btn btn-danger"   data-original-title="Remove"><i class="fa fa-times-circle"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <li>
                            <div>
                                ...
                                <p class="text-right">
                                    <a href="{{route('cart.list')}}"><strong><i class="fa fa-shopping-cart"></i> View Cart</strong></a>
