    ...
    <div class="page-header">
        ...
        <script type="text/javascript">
            ...
            function addImage() {
                ...
                html += '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" placeholder="{{trans('product.entry_sort_order')}}" class="form-control" /></td>';
