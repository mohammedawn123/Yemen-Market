...
$('#button-upload').on('click', function() {
	...
	$('body').prepend('<form enctype="multipart/form-data" id="form-upload" style="display: none;">  <?php echo e(csrf_field()); ?><input type="file" name="file" value="" /></form>');
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			clearInterval(timer);
			 $.ajax({
				url: "<?php echo e(url('admin/uploads/filemanager/upload_file')); ?>" + '/'+ str  ,
				type: 'post',
				dataType: 'json',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: "<?php echo e(url('admin/uploads/filemanager/folder')); ?>" ,
			type: 'post',
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $data['text_confirm'] ; ?>')) {
		$.ajax({
			url:  "<?php echo e(url('admin/uploads/filemanager/delete_folder')); ?>" ,
			type: 'post',
			dataType: 'json',
...
//--></script>
<?php /**PATH C:\xampp\htdocs\yamenmarket\resources\views/admin/filemanager.blade.php ENDPATH**/ ?>